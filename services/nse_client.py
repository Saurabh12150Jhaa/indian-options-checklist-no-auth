...
class NSEClient:
    ...
    def get_session(self) -> curl_requests.Session:
        """Return the underlying HTTP session with fresh cookies.

        This is the preferred way for code that needs raw session access
        (e.g. downloading binary files).  It ensures cookies are valid
        before handing back the session object.
        """
